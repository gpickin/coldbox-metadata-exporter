...
*/
component extends="coldbox.system.testing.BaseInterceptorTest" interceptor="interceptors.WireboxMappingsExporter"{
	...
	function run(){
		...
		describe( "interceptors.WireboxMappingsExporter", function(){
