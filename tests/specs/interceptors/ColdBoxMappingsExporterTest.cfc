...
*/
component extends="coldbox.system.testing.BaseInterceptorTest" interceptor="interceptors.ColdBoxMappingsExporter"{
	...
	function run(){
		...
		describe( "interceptors.ColdBoxMappingsExporter", function(){
